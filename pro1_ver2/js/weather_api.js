...
let minute = today.getMinutes() - 30; /* 갱신이 매 정각 20분 후에 갱신된다. */
// console.log(minute);
if (minute < 0) {
  if (hours == 0) {
    date -= 1;
...
async function get_data1() {
  const url = `https://apis.data.go.kr/1360000/VilageFcstInfoService_2.0/getUltraSrtNcst?ServiceKey=${API_KEY}&pageNo=1&numOfRows=1000&dataType=json&base_date=${total_date}&base_time=${total_time}&nx=59&ny=75`;
